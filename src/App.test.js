...
// click on a season, render episodes

test("runs api", async() =>{
    mockFetchShow.mockResolvedValueOnce(mockEpisodesData);
})

test("click on season and render episodes", async() => {
    ...
    // r.getByText(/chapter one/i);
    // expect(r.queryAllByTestId('episode')).toHaveLength(8);
